  ...
  `;
    ...
    return (
        <View className="flex-1 bg-blue-50">
            ...
            <View className=" bg-white flex flex-row pb-10 items-center justify-evenly pt-4 px-10">
                <TouchableOpacity className={"d-flex justify-center items-center gap-2"} onPress={execute}>
                    <MaterialIcons name="share" size={24} color="dodgerblue"/>
                    <Text>Share</Text>
                </TouchableOpacity>
                <TouchableOpacity className={"d-flex justify-center items-center gap-2"} onPress={print}>
                    <MaterialIcons name="print" size={24} color="black"/>
                    <Text>Print</Text>
                </TouchableOpacity>
                {Platform.OS === 'ios' && (
                    <TouchableOpacity className={"d-flex justify-center items-center gap-2"} onPress={selectPrinter}>
