                    ...
                    <View className={"w-full flex-1"}>
                        <>
                            <Controller
                                ...
                                defaultValue=""
                            />
                            {errors?.email && <Text variant={"bodySmall"}
                                                    className={"text-amber-700 font-bold mt-1"}>*{errors?.email?.message}</Text>}
                            <View className={"mb-4 "}/>
                            <Controller
                                control={control}
                                rules={{
                                ...
                                defaultValue=""
                            />
                            {errors?.password && <Text variant={"bodySmall"}
                                                       className={"text-amber-700 font-bold mt-1"}>*{errors?.password?.message}</Text>}
